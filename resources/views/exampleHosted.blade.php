    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">{{$getBook->title}}</h6>
                        <div class="col-md-3">
          
                            <img src="{{ asset('images/books/'.$getBook->image) }}" style="width: 100px; height:100px;" />
                          </div>
                       
                    </div>
                    <span class="text-muted">{{$getBook->price}} Tk</span>
                </li>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <input type="hidden" value="{{$getBook->id}}" name="book_id" hidden>
                <div class="row">
